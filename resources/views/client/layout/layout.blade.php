...
<head>
    ...
    <meta name="msapplication-config" content="{{ asset('client/assets/images/icons/browserconfig.xml') }}">
    <meta name="theme-color" content="#ffffff">
    <link rel="stylesheet"
        href="{{ asset('client/assets/vendor/line-awesome/line-awesome/line-awesome/css/line-awesome.min.css') }}">
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{ asset('client/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('client/assets/css/plugins/magnific-popup/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('client/assets/css/plugins/jquery.countdown.css') }}">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{ asset('client/assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('client/assets/css/skins/skin-demo-4.css') }}">
    <link rel="stylesheet" href="{{ asset('client/assets/css/demos/demo-4.css') }}">
</head>
...
<body>
    <div class="page-wrapper">
        <header class="header header-intro-clearance header-4">
            ...
            @include('client.partial.headerTop')

            @include('client.partial.headerMiddle')

            @include('client.partial.headerBottom')
        ...
        <footer class="footer">
            ...
            @include('client.partial.footerImage')

            @include('client.partial.footerMiddle')

            @include('client.partial.footerBottom')
    ...
    <script src="{{ asset('client/assets/js/bootstrap-input-spinner.js') }}"></script>
    <script src="{{ asset('client/assets/js/jquery.plugin.min.js') }}"></script>
    ...
    <script src="{{ asset('client/assets/js/demos/demo-4.js') }}"></script>
</body>
