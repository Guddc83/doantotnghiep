                    ...
                    <div class="col-md-6">
                        <div class="product-gallery">
                            <figure class="product-main-image">
                                <img id="product-zoom"
                                    src="{{ asset('client/assets/images/products/single/extended/3.jpg') }}"
                                    data-zoom-image="{{ asset('client/assets/images/products/single/extended/3-big.jpg') }}"
                                    alt="product image">
                            ...
                            <div id="product-zoom-gallery" class="product-image-gallery">
                                <a class="product-gallery-item" href="#"
                                    data-image="{{ asset('client/assets/images/products/single/extended/1.jpg') }}"
                                    data-zoom-image="{{ asset('client/assets/images/products/single/extended/1-big.jpg') }}">
                                    <img src="{{ asset('client/assets/images/products/single/extended/1-small.jpg') }}"
                                        alt="product side">
                                </a>

                                <a class="product-gallery-item" href="#"
                                    data-image="{{ asset('client/assets/images/products/single/extended/2.jpg') }}"
                                    data-zoom-image="{{ asset('client/assets/images/products/single/extended/2-big.jpg') }}">
                                    <img src="{{ asset('client/assets/images/products/single/extended/2-small.jpg') }}"
                                        alt="product cross">
                                </a>

                                <a class="product-gallery-item active" href="#"
                                    data-image="{{ asset('client/assets/images/products/single/extended/3.jpg') }}"
                                    data-zoom-image="{{ asset('client/assets/images/products/single/extended/3-big.jpg') }}">
                                    <img src="{{ asset('client/assets/images/products/single/extended/3-small.jpg') }}"
                                        alt="product with model">
                                </a>

                                <a class="product-gallery-item" href="#"
                                    data-image="{{ asset('client/assets/images/products/single/extended/4.jpg') }}"
                                    data-zoom-image="{{ asset('client/assets/images/products/single/extended/4-big.jpg') }}">
                                    <img src="{{ asset('client/assets/images/products/single/extended/4-small.jpg') }}"
                                        alt="product back">
                                </a>
                ...
                <div class="tab-pane fade show active" id="product-desc-tab" role="tabpanel"
                    ...
                    <div class="product-desc-content">
                        <div class="product-desc-row bg-image"
                            style="background-image: url('{{ asset('client/assets/images/products/single/extended/bg-1.jpg') }}')">
                            <div class="container">
            ...
            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div class="product product-7">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/products/product-4.jpg') }}" alt="Product image"
                                class="product-image">
                        </a>
                ...
                <div class="product product-7">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/products/product-6.jpg') }}" alt="Product image"
                                class="product-image">
                        </a>
                ...
                <div class="product product-7">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/products/product-11.jpg') }}" alt="Product image"
                                class="product-image">
                        </a>
                ...
                <div class="product product-7">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/products/product-10.jpg') }}" alt="Product image"
                                class="product-image">
                        </a>
                ...
                <div class="product product-7">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/products/product-7.jpg') }}" alt="Product image"
                                class="product-image">
                        </a>
