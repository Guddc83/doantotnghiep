...
@section('content')
    ...
    <div class="container">
        <div class="page-header page-header-big text-center"
            style="background-image: url('{{ asset('client/assets/images/contact-header-bg.jpg') }}')">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-2 mb-lg-0">
                    ...
                    <p class="mb-3">Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-xl-6">
                                    <figure class="store-media mb-2 mb-lg-0">
                                        <img src="{{ asset('client/assets/images/stores/img-1.jpg') }}" alt="image">
                    ...
                    <div class="col-lg-6">
                        <div class="store">
                            <div class="row">
                                <div class="col-sm-5 col-xl-6">
                                    <figure class="store-media mb-2 mb-lg-0">
                                        <img src="{{ asset('client/assets/images/stores/img-2.jpg') }}" alt="image">
                                    </figure><!-- End .store-media -->
                                </div><!-- End .col-xl-6 -->
