    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-4">
            <div class="banner banner-overlay banner-overlay-light">
                <a href="#">
                    <img src="{{ asset('client/assets/images/demos/demo-4/banners/banner-1.png') }}" alt="Banner">
                </a>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="banner banner-overlay banner-overlay-light">
                <a href="#">
                    <img src="{{ asset('client/assets/images/demos/demo-4/banners/banner-2.jpg') }}" alt="Banner">
                </a>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="banner banner-overlay banner-overlay-light">
                <a href="#">
                    <img src="{{ asset('client/assets/images/demos/demo-4/banners/banner-3.png') }}" alt="Banner">
                </a>
