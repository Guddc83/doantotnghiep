        ...
        <div class="row justify-content-center">
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-10.jpg') }}"
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-11.jpg') }}"
                                alt="Product image" class="product-image">
                        </a>
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a href="product.html">GoPro - HERO7 Black HD
                                Waterproof Action</a></h3><!-- End .product-title -->
                        <div class="product-price">
                            $349.99
                        </div><!-- End .product-price -->
                        <div class="ratings-container">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-12.jpg') }}"
                                alt="Product image" class="product-image">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-12-2.jpg') }}"
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a href="product.html">Apple - Apple Watch Series 3
                                with White Sport Band</a></h3><!-- End .product-title -->
                        <div class="product-price">
                            $214.49
                        </div><!-- End .product-price -->
                        <div class="ratings-container">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-13.jpg') }}"
                                alt="Product image" class="product-image">
                        </a>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-14.jpg') }}"
                                alt="Product image" class="product-image">
                        </a>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-15.jpg') }}"
                                alt="Product image" class="product-image">
                        </a>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        <span class="product-label label-circle label-sale">Sale</span>
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-16.jpg') }}"
                                alt="Product image" class="product-image">
                        </a>
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="product product-2">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('client/assets/images/demos/demo-4/products/product-17.jpg') }}"
                                alt="Product image" class="product-image">
                        </a>
